...
export default function LoginPage() {
    ...
    return (
        <main className="min-h-screen bg-[#080706] flex items-center justify-center relative overflow-hidden">
            {/* Bindu Glow */}
            <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-accent/8 blur-[180px] rounded-full pointer-events-none" />
            ...
            <div className="relative z-10 w-full max-w-md mx-auto px-6">
                ...
                <div className="text-center mb-12 space-y-4">
                    ...
                    <h1 className="font-serif text-4xl md:text-5xl text-white font-light tracking-tight">
                ...
                {/* Form Card */}
                <div className="bg-white/[0.03] backdrop-blur-xl border border-white/10 rounded-[24px] p-8 md:p-10 shadow-[0_30px_80px_rgba(0,0,0,0.5)]">
                    {error && (
                        ...
                        {mode === 'signup' && (
                            <div>
                                ...
                                <input
                                    ...
                                    required
                                    disabled={isLoading}
                                    className="w-full px-4 py-3.5 bg-white/5 border border-white/15 text-white placeholder-white/30 focus:outline-none focus:ring-2 focus:ring-accent/50 focus:border-accent/30 rounded-xl transition-all text-base font-sans disabled:opacity-50"
