    ...
    <div className="relative w-full h-screen overflow-hidden bg-black text-white font-sans">
      ...
      <div className="relative z-10 w-full h-full flex flex-col items-center justify-between py-12">
        ...
        <div className="flex-1 flex items-center justify-center relative">
          ...
          {/* Secondary Glow - The warm presence */}
          <motion.div
            animate={{ 
              scale: [1, 1.3, 1],
              opacity: [0.4, 0.6, 0.4],
            ...
            className="absolute w-24 h-24 bg-gradient-to-r from-amber-400 to-yellow-500 rounded-full blur-2xl opacity-50"
          />
          ...
          <motion.div
            ...
            className="absolute w-[400px] h-[400px] flex items-center justify-center opacity-20 pointer-events-none"
          >
          ...
          {/* Intense Core - The power source */}
          <motion.div
            animate={{ 
              scale: [1, 1.1, 1],
              boxShadow: [
                "0 0 20px 2px rgba(251,191,36,0.6)",
                "0 0 40px 8px rgba(251,191,36,0.8)",
                "0 0 20px 2px rgba(251,191,36,0.6)"
              ]
            }}
          ...
          >
            {/* Core Lens Flare */}
            <div className="absolute inset-x-[-150%] inset-y-[45%] bg-white blur-[4px] opacity-40 rounded-full scale-y-[0.1]" />
            <div className="absolute inset-y-[-150%] inset-x-[45%] bg-white blur-[4px] opacity-40 rounded-full scale-x-[0.1]" />
          </motion.div>
