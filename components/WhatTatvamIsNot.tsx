export default function WhatTatvamIsNot() {
    ...
    return (
        <section className="px-6 md:px-12 py-24 md:py-32 bg-background border-t border-border/50 overflow-hidden relative">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    <div className="space-y-4">
                        {points.map((point, idx) => (
                            <div key={idx} className="flex items-center gap-4 p-4 rounded-2xl bg-secondary/10 border border-border/30 group hover:border-destructive/20 transition-all duration-300">
                    ...
                    <div className="p-10 rounded-[3rem] bg-[#FAF8F5] border border-border/80 text-center space-y-6 relative overflow-hidden group shadow-sm">
